...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./yolov5-blazeface.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--dataset_folder', default='D:/projects/cv/Task2/yolov5-face/retinaface_gt_v1.1/val/images', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='D:/projects/cv/Task2/yolov5-face/retinaface_gt_v1.1/val/wider_val.txt', type=str, help='folder_pict')
    ...
    with torch.no_grad():
        ...
        for image_path in tqdm(glob.glob(os.path.join(testset_folder, '*', '*'))):###21
